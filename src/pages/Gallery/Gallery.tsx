...
export default function Gallery() {
    ...
    const notes: string[] = [
        ...
        "พอเค้าลองคิดแล้วเค้าก็เข้าใจแล้วคับ ทั้งๆที่เค้าอยู่ข้างๆเธอ แต่ว่าเธอบอกเขาว่าเธอพึ่งอะไรเค้าไม่ได้เลยจนเธอต้องไปพึ่งคนอื่นแทน",
        ...
        "หลายวันที่ผ่านมานี้ เค้าพยามคิดแล้วก็หาวิธีรักษาความสัมพันธ์ของเราแล้วนะคะ จริงๆเค้าอยากแก้มันมากๆ แต่เค้าจะยอมรับการตัดสินใจของเธอนะ เพราะที่ผ่านมาเค้าแย่จริงๆ เค้าอะไรให้เธอไม่ได้เลยอะ คือตอนนี้เค้าได้แค่จับมือเธอไว้เท่านั้นไม่กล้าที่จะดึงมือเธอมาด้วยซ้ำ",
        ...
        "เรื่องจริงนะคะที่เวลาเค้าเห็นเธอยิ้มเค้ามีความสุขมากๆ แต่ขอโทษจริงๆครับที่เค้าไม่เคยทำให้เธอยิ้มเลย เธอบอกเธอพยายามยิ้มเองแต่เขาก็อย่ากทำให้เธอยิ้มบ้างอะ",
