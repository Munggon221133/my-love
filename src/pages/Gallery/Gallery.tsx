            ...
            {hasCards && slice.length > 0 ? (
                ...
                <div className="swipe-empty">
                    <p>
                        ...
                        เพราะตอนที่เรารักกัน เค้ารู้สึกว่าเราสองคนมีความสุขกันมากๆ อยากให้เราได้มีความสุขแบบนี้ด้วยกันอีกจิงๆๆ ตอนนี้เค้าอยากพูดคำนี้มากๆ
                        "ข้าวฟ่างเป็นแฟนกับนัททีน้าาาาาาาาาาาาาาา 🥹💞"
                    </p>
...
export default function Gallery() {
    ...
    const notes: string[] = [
        "สิ่งแรกเลยที่อยากจะบอกคือ เค้าคิดถึงเธอจิงๆน้าาา 💗 คิดถึงมากกๆๆๆ ไม่รู้เธอคิดถึงเค้ามั้ย แต่เค้าคิดถึงสุดๆ",
        "จิงๆเค้ารู้คับว่าเธอรักเค้ามากกกกๆๆๆๆๆๆ คือมากๆๆจิงๆ เค้ารับรู้ได้ตั้งแต่ปีแรกๆเลย",
        "เธอเป็นคนขี้เขินมากกับเค้า เลยไม่แสดงออกมาตรงๆ ปากบอกไม่ แต่สิ่งที่เธอทำมันทำให้เค้ารู้สึกถึงความรักจากเธอจิงๆเลยคับ🥹",
        "ช่วงแรกเธอให้ใจเค้าเต็มที่จิงๆ เค้าขอบคุณเธอมากๆนะคะ คือเค้ามีความสุขมากๆๆๆ",
        "เค้าอยากบอกว่า ตอนแรกเค้ามีความรู้สึกกับเธอจิงๆนะคับ ยอมรับว่าในความคิดแรกไม่คิดว่าเราจะมาไกลขนาดนี้ แต่พอเวลาผ่านไป หลายวัน เดือน และเป็น ปี ที่ได้รู้จักเธอ ได้มีเธอเข้ามาเป็นส่วนหนึ่งในชีวิต",
        "จากความรู้สึกธรรมดาๆ มันก็เริ่มเปลี่ยนไปเรื่อยๆ เค้าตกหลุมรักเธอจิงๆนะ เค้ารู้สึกว่าเค้าไม่เคยมีความสุขแบบนี้มาก่อน คือ แค่ได้ยินเสียงผู้หญิงคนนี้ ก็มีความสุขแล้ว",
        "ซึ่งเธอก็พยายามมากๆ เธอทุ่มเทความรักให้เค้าสุดๆ เค้ารู้สึกได้จริงๆคับ แต่เค้ากลับปิดกั้นเธอมาตลอด ตอนนี้เค้ารู่สึกแย่จริงๆที่เค้าเป็นคนนิสัยไม่ดีมากๆ",
        "และพอถึงวันที่เค้าบอกได้เต็มปากว่าเค้ารักเธอ เค้ากลับไม่ทำไรเลย ไม่แสดงความชัดเจน หรือ แสดงให้เธอเห็นว่าเค้ารักเธอจิงๆ",
        "โดยที่เธอแคร์เค้าขนาดนี้ แต่เค้าก็ยังแคร์คนรอบข้างอยู่ ไม่ได้ทำให้เธอรู้สึกเลยว่า เธอเป็นคนสำคัญสำหรับเค้า",
        "ที่ผ่านมาเค้าขอบคุณเธอมากๆนะคะ ที่เธอพยายามทำให้เค้ารู้สึกเป็นคนสำคัญของเธอจิงๆ ซึ่งเค้ามีความสุขมากๆเวลาอยู่กับเธอ🥹 เค้าได้เรียนรู้จากเธอหลายๆอย่างมากๆ",
        "แต่เค้าก็ได้ทำผิดพลาดไปจิงๆ แค่ความชัดเจนเค้าก็ไม่ได้ทำให้เธอได้เห็น แต่เค้าอยากเอาสิ่งที่เรียนรู้ กับ ความผิดพลาด มาแก้ไขความสัมพันธ์ของเราอีกครั้งนะคะ🥺",
        "ตั้งแต่ต้นปีที่ผ่านมาถึงปัจจุบัน เค้ารู้สึกได้จิงๆ ที่ผ่านมาเธอพยายามยื้อความสัมพันธ์ของเรามาตลอด แต่สิ่งที่ง่ายๆ นัททียังไม่สามารถทำได้เลย ที่จะบอกเรื่องเธอให้คุณแม่รับรู้ ความใส่ใจที่จะไปหาเธอ และยังมีความต้องการอีกหลายอย่างที่เธอต้องการจากเค้า",
        "ที่เค้าไม่สามารถทำให้เธอได้ เค้ารู้สึกทำให้เธอต้องลดมาตราฐานตัวเองมาอยู่กับเค้าจริงๆ เค้าไม่รู้จะอธิบายยังไง จิงๆเค้าไม่อยากให้คนที่เค้ารัก ต้องมารู้สึกแย่แบบนี้เลย",
        "ทุกวันที่เราห่างกัน เค้ารู้สึกกลัวมากๆ กลัวว่าเราจะไม่ได้กลับมาหากันอีก เธอจะไปจริงๆมั้ยน้า เค้านั่งคิดอยู่ทุกวัน เลยคับ จิงๆตอนนี้เธอมีเหตุผลที่สามารถไปจากเค้าได้จิงๆ",
        "เค้าอาจจะดูเห็นแก่ตัว แต่เค้าไม่อยากให้เธอไปเลยนะคะ🥺 อันนี้เป็นความรู้สึกของเค้าจิงๆ เค้าอยากทำให้เธอรู้สึกเป็นคนสำคัญของเค้า เค้าจะเปิดเผยความรู้สึกมากกว่านี้ และชัดเจนมากกว่านี้คับ เค้าอยากให้เธอมีตัวตนอยู่ในชีวิตเค้าจิงๆ",
        "เค้าอยากคุยกับเธออีก อยากทานข้าวกับเธออีก อยากอยู่กับเธออีก อยากเที่ยวกับเธออีก อยากหัวเรอะ ยิ้ม ทำตัวบ้าๆบอกับเธออีกนะ อยากกอดเธออีก อยากบอกรักเธออีกหลายๆครั้งเลยคับ",
        "เค้าอยากดูแลเธอให้ดีขึ้นกว่าเดิม 🥹💗 เค้าอยากขอโอกาสเธออีกครั้ง เค้าพยายามได้มากกว่านี้คับ อยากพยายามไปพร้อมกับเธอจิงๆคับ",
        "ไม่รู้จะบอกอะไร นัททีอยากจะให้เรากลับมาหากันอีกครั้งนะคะ ข้าวฟ่าง 🥹💞",
    ];
    ...
    const onClickYes = () => {
        ...
        position:fixed; inset:0; display:flex; justify-content:center; align-items:center; padding:20px;
        background:rgba(0,0,0,.6); color:white; font-size:20px; font-weight:600; z-index:9999;">
        ☎️ โทรหาเค้าน้าาา เค้าอยากคุยกับแฟนแล้วอะ 💗 (เหมือนมัดมือชกแต่อยากคุยด้วยจิงๆน้าาอ้วน)
      </div>`
        );
        setTimeout(() => {
        ...
        <div className="credits-page" style={{ backgroundColor: "#ddb892" }}>
            ...
            {showChoices && (
                <div className="choices-container">
                    ...
                    <div className="choices-prompt">ตกลง 💗 กดปุ่ม "ได้" เร็วค่ะ</div>
