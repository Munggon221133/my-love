            ...
            {hasCards && slice.length > 0 ? (
                ...
                <div className="swipe-empty">
                    <p>
                        ...
                        เพราะตอนที่เรารักกัน เค้าก็มีความสุขมากๆอยู่แล้ว อยากให้เราได้มีความสุขแบบนั้นด้วยกันอีกครั้งนะคะ
                    </p>
...
export default function Gallery() {
    ...
    const notes: string[] = [
        ...
        "ความคิดเค้าที่ผ่านมาเค้าแค่รู้สึกเวลาเราคุยกันดีๆ ไม่นอกใจกัน ตอบแชทโทรคุยเป็นประจำหรือแค่มีเธออยู่ข้างๆ ได้ยินเสียงเธอได้เห็นหน้าเธอ เค้าก็มีความสุขแล้ว",
        ...
        "เรื่องจริงนะคะที่เวลาเค้าเห็นเธอยิ้มเค้ามีความสุขมากๆ แต่ขอโทษจริงๆครับที่เค้าไม่เคยทำให้เธอยิ้มเลย เธอบอกเธอพยายามยิ้มเองแต่เค้าก็อยากทำให้เธอยิ้มบ้างอะ",
        "ที่ผ่านมาเค้าทำความสัมพันธ์ของเราแย่จิงๆ แต่ตอนนี้เค้าอยากทำสิ่งที่ต้องทำมาตั้งนานแล้ว เค้าอยากเปิดเผยมันมากกว่านี้ และเค้าอยากเดินไปข้างหน้าพร้อมเธอจริงๆแล้วนะคะ เค้าอยากจะพยายามอีก🥺 น้าาาอะหมูอ้วน🐽 เค้าอยากทำไห้เธอเห็น",
        "คืนดีกันได้แล้วนะคะ🙆‍♂️ เค้าให้เธอกระทืบเค้าเลยก็ได้🤕 อยากระบายอะไร นัททีจะรับเองแงงงงง😭",
        "มีต่อๆนะ",
    ];
