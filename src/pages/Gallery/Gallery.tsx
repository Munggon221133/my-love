...
export default function Gallery() {
    ...
    const notes: string[] = [
        ...
        "ช่วงแรกๆ เค้ายอมรับคับว่าเค้าไม่ได้รู้สึกรักเธอตั้งแต่แรก เหมือนกับเธอให้เค้า 100 ส่วนนัททีเริ่มจาก 10",
        ...
        "ซึ่งเธอก็พยายามมากๆ เธอทุ่มเทความรักให้เค้าสุดๆ เค้ารู้สึกได้จริงๆนะคับ แต่เค้ากลับปิดกั้นเธอมาตลอด ตอนนี้เค้ารู่สึกแย่จริงที่เค้าเป็นคนนิสัยไม่ดีมากๆ",
        ...
        "พอนั่งคิดมาเรื่อยๆ เค้าเสียใจมากๆคับ ที่ทำตัวแย่ๆแบบนี้กับเธอ เธอก็รู้สึกไม่สบายใจมาตลอด แต่เค้าดันกลับไม่ทำไรเลย",
        "ทั้งๆที่เธอทุ่มเทสุดๆ เธอพยายามมากๆ แต่เค้ากลับไม่ทำอะไรให้เธอเลย และก็ปล่อยให้เธอไม่สบายใจมาตลอด",
    ];
