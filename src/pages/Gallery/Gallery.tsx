...
export default function Gallery() {
    ...
    const notes: string[] = [
        ...
        "จิงๆเธอรักเค้ามากกกกๆๆๆๆๆๆ คือมากๆๆจิงๆ เค้ารับรู้ได้ตั้งแต่ปีแรกๆเลย",
        "เธอเป็นคนขี้เขินมากกับเค้า เลยไม่แสดงออกมาตรงๆ ปากบอกไม่ แต่สิ่งที่เธอทำมันทำให้เค้ารู้สึกถึงความรักจากเธอจิงๆเลยคับ🥹",
        "ช่วงแรกๆ เค้ายอมรับคับว่าเค้าไม่ได้ให้เธอเต็มร้อย เหมือนกับเธอให้เค้า 100 ส่วนนัททีเริ่มจาก 10",
        "คือมันไม่ใช่ 0 ตอนแรกเค้ามีความรู้สึกกับเธอจิงๆนะคับ แต่พอเวลาผ่านไป หลายวัน เดือน และเป็น ปี ที่ได้รู้จักเธอ ได้มีเธอเข้ามาเป็นส่วนหนึ่งในชีวิต",
        ...
        "ซึ่งเธอก็พยายามมากๆ เธอทุ่มเทความรักให้เค้าสุดๆ เค้ารู้สึกได้จริงๆนะคับ แต่เค้ากลับปิดกั้นเธอมาตลอด ตอนนี้เค้ารู่สึกแย่จริงๆที่เค้าเป็นคนนิสัยไม่ดีมากๆ",
        "และพอถึงวันที่เค้าบอกได้เต็มปากว่าเค้ารักเธอ เค้ากลับไม่ทำไรเลย ไม่แสดงความชัดเจน หรือ แสดงให้เธอเห็นว่าเค้ารักเธอจิงๆ",
        "โดยที่เธอแคร์เค้าขนาดนี้ แต่เค้าก็ยังแคร์คนรอบข้างอยู่ ไม่ได้ทำให้เธอรู้สึกเลยว่า เธอเป็นคนสำคัญสำหรับเค้าจริงๆ",
        "ที่ผ่านมาเค้าขอบคุณเธอมากๆนะคะ ที่เธอพยายามทำให้เค้ารู้สึกเป็นคนสำคัญของเธอ ซึ่งเค้ามีความสุขมากๆจิงๆเวลาอยู่กับเธอ🥹 เค้าได้เรียนรู้จากเธอหลายๆอย่าง และเค้าก็ทำผิดพลาดอะไรหลายอย่างด้วย",
        "แต่เค้าอยากเอาสิ่งที่เรียนรู้ กับ ความผิดพลาด มาแก้ไขความสัมพันธ์ของเราอีกครั้งนะคะ🥺",
        "ทุกวันที่เราห่างกัน เค้ารู้สึกกลัวมากๆ กลัวว่าเราจะไม่ได้กลับมาหากันอีก เธอจะไปจริงๆมั้ยน้า เค้านั่งคิดอยู่ทุกวัน เลยคับ",
        "อาจจะดูเห็นแก่ตัวอีกแล้ว แต่เค้าไม่อยากให้เธอไปเลยนะคะ🥺 เค้าอยากทำให้เธอรู้สึกเป็นคนสำคัญของเค้า เค้าจะเปิดเผยความรู้สึกมากกว่านี้ และชัดเจนมากกว่านี้คับ",
        "เค้าอยากคุยกับเธออีก อยากทานข้าวกับเธออีก อยากอยู่กับเธออีก อยากเที่ยวกับเธออีก อยากหัวเรอะ ยิ้ม ทำตัวบ้าๆบอกับเธออีกนะ",
        "เค้าอยากดูแลเธอให้ดีขึ้นกว่าเดิม น้าาาา อ้วนคืนดีกันนะคะ 🥹💗"
    ];
