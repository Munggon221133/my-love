...
export default function Gallery() {
    ...
    const notes: string[] = [
        "ก่อนจะถึงเดือนธันวาเค้าอยากจะบอกเล่าความรู้สึกให้เธอจริงๆ",
        "จริงๆเค้าอยากอยากคุยต่อหน้ากันมากกว่า แต่เวลาคุยต่อหน้าเธอทีไรเค้าเรียบเรียงคำพูดไม่ค่อยถูก😅",
        "เค้าอดทนอยู่โดยที่ไม่มีเธอตามที่เธอบอกแล้วนะคือมันยากจริงๆคับ🥲 ตอนแรกรู้สึกแย่จริงๆ",
        "ไม่รู้ว่าเธอเป็นเหมือนกันมั้ย อาจจะดูน้ำเน่าแต่มันเป็นเรื่องจิงเลย ที่เราดันไม่เห็นค่าคนที่รักเราจิงๆ จนกว่าจะเสียคนคนนั้นไป",
        "เค้าใช้เวลาทบทวนตัวเองอยู่หลายวัน ซึ่งเค้าควรจะคิดแบบนี้ตั้งนานแล้ว แต่ที่ผ่านมาเค้าดันเอาอารมณ์เข้ามาใช้ตลอด",
        "แต่พอนึกย้อนกลับไปแล้วทำให้รู้เลยคับ อย่างที่เธอบอกจริงๆเลยค่ะเธอพยายามมากๆ เธอทำทุกอย่างเท่าที่ทำได้",
        "เธอพยายามรักษาความสัมพันธุ์ของเรามาตลอดหลายปีที่ผ่านมา เธอเปิดใจให้เค้ามากๆ เธอยกให้เค้าเป็นอันดับหนึ่งจิงๆ และเธอแคร์เค้ามากๆ",
        "ไม่รู้ว่าจะอธิบายยังไง เธอทุ่มเทให้เค้าจิงๆนะคะ แต่พอถึงวันที่เค้ารักเธอขึ้นมาจริงๆ เค้ายังรู้จักแต่ความรักเด็กๆไปวันๆ นั่นแหละมันดูไม่โตอย่างที่เธอพูด",
        ...
        "หรือชีวิตเค้าปกติไม่ค่อยได้ออกไปไหน ไม่ไปเที่ยว ไม่ติดเพื่อน เค้าแค่นั่งทำงานนั่งเรียนไปวันๆแล้วก็รอคุยกับเธอแค่นั้น",
        "แต่มันกลับไม่ใช่เลยมันดันกลายเป็นการไม่ทำอะไรจริงๆ แค่รู้สึกว่าให้ข้าวฟ่างมาอยู่ข้างๆตัวเองจนมองข้ามความรู้สึกของเธอไป เหมือนให้เธอมายืนพิงท่อนไม้ และเธอก็ดูแลมันดีมากๆ แต่เค้ากับไม่มีกิ่งก้านอะไรไปบังฝนบังแดดให้เธอเลย เค้าดันรู้สึกแค่มีเธออยู่ข้างๆก็พอใจแล้ว มันดูเห็นแก่ตัวสุดๆ",
        "ปากที่บอกว่ารัก แต่เค้ากลับไม่เคยแสดงออกให้เธอเห็นเลยจริงๆ สิ่งง่ายๆ แต่เค้ากลับไม่ได้ทำ",
        ...
        "จริงๆเค้ารู้สึกเสียใจมากๆเวลาที่เธอเอาเค้าไปเปรียบเทียบกับคนอื่นว่า เค้าไม่เท่าคนนี้เค้าไม่เท่าคนนั้น ตอนนั้นเราอาจจะคุยกันด้วยอารมณ์ จนเราพูดอะไรที่แย่ใส่กัน และเค้าก็รู้สึกแย่มากๆ แต่ที่จริงเธอก็รู้สึกแย่เหมือนดกัน",
        "คือพอเค้าคิดมาถึงตรงนี้เค้าก็ รู้สึกไม่ดีจริงๆคับ ที่เค้าทำนิสัยเห็นแก่ตัว ที่จะรับจากเธออย่างเดียว🥹 โดยเค้าไม่นึกถึงความรู้สึกของเธอเลย",
        ...
        "เรื่องจริงนะคะที่เวลาเค้าเห็นเธอยิ้มเค้ามีความสุขมากๆ ขอโทษจริงๆครับที่เค้าไม่เคยทำให้เธอยิ้มเลย และปิดกั้นความพยายามของเธอมาโดยตลอดด้วย",
        "ที่ผ่านมาเค้าทำความสัมพันธ์ของเราแย่จิงๆ แต่ตอนนี้เค้าอยากทำสิ่งที่ต้องทำมาตั้งนานแล้ว เค้าอยากเปิดเผยมันมากกว่านี้ และเค้าอยากเดินไปข้างหน้าพร้อมเธอจริงๆแล้วนะคะ เค้าจะพยายามอีก🥺 น้าาาอะหมูอ้วน🐽 เค้าอยากทำไห้เธอเห็น",
        "คืนดีกันได้แล้วนะคะ🙆‍♂️ เค้าให้เธอกระทืบเค้าเลยก็ได้🤕 อยากระบายอะไร นัททีจะรับเองแงงงงง😭 เค้ารักเธอนะคับ",
        "เค้าอยากให้เราสองคนกลับมาบอกรักกันจากใจจริงๆโดยไม่ไปบังคับอีกฝ่าย แล้วมาพยายามไปพร้อมกันนะคับ ข้าวฟ่าง🥹💗",
    ];
